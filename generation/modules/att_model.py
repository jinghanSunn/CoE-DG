...
class AttModel(CaptionModel):
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None, opt={}):
        ...
        # p_fc_feats, p_att_feats, pp_att_feats, p_att_masks, pred = self._prepare_feature(fc_feats, att_feats, att_masks)
        ...
        # return seq, seqLogprobs, pred
        return seq, seqLogprobs

    def _sample(self, fc_feats, att_feats, att_masks=None, location_rep=None, label_name=None):
        ...
        if location_rep is not None:
            p_fc_feats, p_att_feats, pp_att_feats, p_att_masks, cls_token = self._prepare_feature(fc_feats, att_feats, att_masks)
        else:
            if label_name is not None:
                p_fc_feats, p_att_feats, pp_att_feats, p_att_masks, cls_token = self._prepare_feature(fc_feats, att_feats, att_masks, location_rep, label_name)
            else:
                p_fc_feats, p_att_feats, pp_att_feats, p_att_masks, cls_token = self._prepare_feature(fc_feats, att_feats, att_masks, location_rep)
