"""
Trainer classes for report generation with object detection guidance.

This module contains trainer classes for training medical report generation models
with object detection-based visual features.
"""
import json
import os
import time
...
class BaseTrainer(object):
    """
    Base trainer class for report generation with detection guidance.

    This class provides common functionality for training medical report generation
    models with object detection features.

    Args:
        model: Report generation model
        retinanet: Object detection model (RetinaNet)
        criterion: Loss function for report generation
        metric_ftns: Metric computation functions
    ...
    def __init__(self, model, retinanet, criterion, metric_ftns, optimizer, args):
        ...
        # Setup GPU device if available, move models to configured device
